-- Retry of db/022_applications.sql, skipping the probes_kind_check
-- narrowing at its original lines 13-15 - that constraint has already
-- been superseded (widened) by migrations 031 and 037, which are live
-- and have real 'proxmox'/'supply_chain' rows that the original 022
-- constraint doesn't include. Everything else from 022 is unchanged.
